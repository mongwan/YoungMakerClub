...
1. 기능적 요구사항
	...
	1. OPP는 문답형식으로 작성된다.
		1. 서버는 사용자에게 "이번 OPP의 제목을 입력해주세요" 를 출력한다.
		1. 서버는 사용자에게 "오늘 만들어 본 것들을 자유롭게 적어주세요" 를 출력한다.
		1. 서버는 사용자에게 "오늘 만들어 보면서 느낀점을 적어주세요" 를 출력한다.
		1. 서버는 사용자에게 "다음 주에 무엇을 할 건지 계획해주세요" 를 출력한다.
		1. 서버는 사용자에게 "다음주 준비물을 적어주세요" 를 출력한다.
		1. 서버는 사용자에게 "활동 사진을 업로드 해주세요"를 출력한다.
		1. 사용자는 로컬저장서에서 사진을 선택할 수 있다.
		1. 서버는 입력받은 정보를 종합해 지정된 프로젝트에 OPP를 저장한다.
...
3. 비기능적 요구사항
	...
	3-1. 최소사양인 테블릿(1.8GHz / 2GB RAM/ Android 6.0)에서 구동이 가능해야 한다.
...
4. 사용자 편의사항 요구사항
	...
	4-1. 주사용자 연령에 맞는 언어와 이용편의도를 고려해 개발한다.  

5. 개발 부가사항
	5-1. V1.@는 데이터 저장과 제품 구현을 목적으로 한다.
	5-1. V1.@는 디자인적 요소를 제외한 매우 직관적인 UI, 기능에 집중한다.
